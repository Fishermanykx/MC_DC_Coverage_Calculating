...
if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  ...
  call void @getTotalConditions(i32 2)
  ret i32 %4
}
...
entry:
  ...
  call void @init(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i32 0, i32 0))
...
if.end:                                           ; preds = %if.then, %land.lhs.true2, %land.lhs.true, %entry
  call void @getTotalConditions(i32 5)
  ret i32 0
}

declare void @init(i8*)

declare void @calCoverage()
